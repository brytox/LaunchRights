...
#ifndef APPADMINSHARED_SWIFT_H
#define APPADMINSHARED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppAdminShared",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP14AppAdminShared14HelperProtocol_")
...
/// The XPC surface both daemons expose (<code>com.jigsaw24.appadmin.helper</code>):
...
/// the XPC prototype (<code>appadmind</code>) or the Endpoint Security daemon
/// (<code>appadmind-es</code>) — with no client-side changes. Only one flavour registers
/// the Mach service at a time (don’t run both).
SWIFT_CLASS("_TtC14AppAdminShared13HelperService")
@interface HelperService : NSObject <HelperProtocol, NSXPCListenerDelegate>
