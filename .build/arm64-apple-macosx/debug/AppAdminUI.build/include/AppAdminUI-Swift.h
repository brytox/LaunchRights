...
#ifndef APPADMINUI_SWIFT_H
#define APPADMINUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppAdminUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSMenu;
/// Shared status-bar controller used by both the standalone <code>appadmin-menu</code>
/// executable and the System Extension host app.
/// Lives in its own target (not <code>AppAdminShared</code>) so the root daemons never link
...
SWIFT_CLASS("_TtC10AppAdminUI14MenuController")
